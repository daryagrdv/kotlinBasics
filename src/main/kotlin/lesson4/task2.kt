...
При работе на таможенном терминале важно точно определить категорию каждого груза. Напиши программу, которая проверяет, соответствует ли груз категории "Average".
...
fun main(){
    ...
    println("Груз с весом $cargoWeight кг соответствует категории 'Average': ${cargoWeight > minWeight && cargoWeight <= maxWeight}")
    ...
    cargoVolume = 100
    println("Груз с объемом $cargoVolume л соответствует категории 'Average': ${cargoVolume < maxVolume}")
